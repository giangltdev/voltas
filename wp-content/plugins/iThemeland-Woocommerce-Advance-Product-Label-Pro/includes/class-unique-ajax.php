...
class unique_Ajax {
	...
	public function __construct() {
		...
		// Update elements
		add_action( 'wp_ajax_unique_update_condition_value', array( $this, 'update_condition_value' ) );
	...
	public function update_condition_value() {
		...
		$wp_condition     = new unique_Condition( $_POST['id'], $_POST['group'], $_POST['condition'] );
