...
class unique_Match_Conditions {
	...
	public function __construct() {
		...
		add_filter( 'unique_match_conditions_product', array( $this, 'condition_match_product' ), 10, 3 );
		add_filter( 'unique_match_conditions_category', array( $this, 'condition_match_product_category' ), 10, 3 );
		add_filter( 'unique_match_conditions_brand', array( $this, 'condition_match_product_brand' ), 10, 3 );
		add_filter( 'unique_match_conditions_product_type', array( $this, 'condition_match_product_type' ), 10, 3 );
		add_filter( 'unique_match_conditions_in_sale', array( $this, 'condition_match_in_sale' ), 10, 3 );
		add_filter( 'unique_match_conditions_bestseller', array( $this, 'condition_match_bestseller' ), 10, 3 );
		add_filter( 'unique_match_conditions_age', array( $this, 'condition_match_age' ), 10, 3 );

		add_filter( 'unique_match_conditions_price', array( $this, 'condition_match_price' ), 10, 3 );
		add_filter( 'unique_match_conditions_sale_price', array( $this, 'condition_match_sale_price' ), 10, 3 );
		add_filter( 'unique_match_conditions_stock_status', array( $this, 'condition_match_stock_status' ), 10, 3 );
		add_filter( 'unique_match_conditions_stock_quantity', array( $this, 'condition_match_stock_quantity' ), 10, 3 );
		add_filter( 'unique_match_conditions_shipping_class', array( $this, 'condition_match_shipping_class' ), 10, 3 );
		add_filter( 'unique_match_conditions_tag', array( $this, 'condition_match_tag' ), 10, 3 );
		add_filter( 'unique_match_conditions_sales', array( $this, 'condition_match_sales' ), 10, 3 );
		add_filter( 'unique_match_conditions_featured', array( $this, 'condition_match_featured' ), 10, 3 );
	...
	public function condition_match_bestseller( $match, $operator, $value ) {
		...
		if ( false === $bestseller_ids = wp_cache_get( 'bestsellers', 'it-woocommerce-advanced-product-labels-pro' ) ) {
			...
			wp_cache_set( 'bestsellers', $bestseller_ids, 'it-woocommerce-advanced-product-labels-pro' );
		}
	...
	public function condition_match_featured( $match, $operator, $value ) {
		...
		if ( false === $featured_ids = wp_cache_get( 'featured', 'it-woocommerce-advanced-product-labels-pro' ) ) {
			...
			wp_cache_set( 'featured', $featured_ids, 'it-woocommerce-advanced-product-labels-pro' );
		}
